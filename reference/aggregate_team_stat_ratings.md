...
For each team in a lineup, sums and averages the stat rating estimates
of the players in that team. Used to create team-level features for
match prediction models.

## Usage

``` r
aggregate_team_stat_ratings(skills, team_lineups, top_n = 22)
