...
test_that("generate_urls handles rounds", {
  ...
  expect_equal(urls,
               c("https://github.com/peteowen1/torpdata/releases/download/pbp-data/pbp_data_2021_01.parquet",
                 "https://github.com/peteowen1/torpdata/releases/download/pbp-data/pbp_data_2021_02.parquet"))
})
