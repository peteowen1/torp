...
# PSV from raw stats.
# Note calculate_psv() centres on `position_group`, which load_player_stats()
# does NOT return -- it returns `position`. Join the listed position on first,
# or the call aborts rather than quietly returning uncentred values.
player_stats$position_group <- player_stats$position
