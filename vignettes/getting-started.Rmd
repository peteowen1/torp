...
See `vignette("player-ratings")` for the full methodology.
...
See `vignette("model-usage")` for details on each model.
...
- `vignette("data-architecture")` -- Data pipeline and storage
