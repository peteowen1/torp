...
plot_ep_wp(2026, round = 1, match_id = "CD_M20260140101")

# Auto-selects match if only one in the round
plot_ep_wp(2026, round = 1)
```

### Expected Points

```{r ep-chart}
plot_ep_wp(2026, round = 1, match_id = "CD_M20260140101", metric = "ep")
```
...
plot_shot_map(2026, round = 1)

# Filter to a specific team
plot_shot_map(2026, round = 1, team = "Geelong")
```
