...
#' @keywords internal
RATING_PRIOR_GAMES_RECV <- 9.3819

#' Prior games constant for disposal ratings
#' @keywords internal
RATING_PRIOR_GAMES_DISP <- 4.9696
...
#' @keywords internal
RATING_PRIOR_RATE_SPOIL <- -2.4973
