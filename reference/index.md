...
- [`get_match_chains()`](https://peteowen1.github.io/torp/reference/get_match_chains.md)
  : Get Match Chains
- [`get_single_chain()`](https://peteowen1.github.io/torp/reference/get_single_chain.md)
  : Get Single Chain
...
- [`get_wp_preds_enhanced()`](https://peteowen1.github.io/torp/reference/get_wp_preds_enhanced.md)
...
- [`create_shot_model_matrix()`](https://peteowen1.github.io/torp/reference/create_shot_model_matrix.md)
  : Create Shot Model Matrix
- [`prepare_shot_model_data()`](https://peteowen1.github.io/torp/reference/prepare_shot_model_data.md)
  : Prepare Shot Data for Modeling
- [`predict_wp_ensemble_baseline()`](https://peteowen1.github.io/torp/reference/predict_wp_ensemble_baseline.md)
  : Ensemble Baseline Win Probability Prediction
- [`predict_wp_expected_points()`](https://peteowen1.github.io/torp/reference/predict_wp_expected_points.md)
  : Expected Points Baseline Model
- [`predict_wp_gam_baseline()`](https://peteowen1.github.io/torp/reference/predict_wp_gam_baseline.md)
  : GAM Baseline Model
- [`predict_wp_score_only()`](https://peteowen1.github.io/torp/reference/predict_wp_score_only.md)
  : Score-Only Baseline Model for Win Probability
- [`predict_wp_time_score()`](https://peteowen1.github.io/torp/reference/predict_wp_time_score.md)
