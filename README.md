...
**torp** is an R package for AFL analytics. It provides a player rating
system (TORP), expected points and win probability models, season
simulations, and easy access to processed AFL data.
...
## Package Ecosystem
    ...
    torp        Core analytics, data loading, ratings, models
    torpdata    Processed AFL data via GitHub releases (parquet)
    torpmodels  Pre-trained models via GitHub releases (RDS)
