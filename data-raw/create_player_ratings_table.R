...
plyr_gm_df <-
  ...
  dplyr::select(player_name, player_id, match_id,utc_start_time,home_away,away_team_team_name,home_team_team_name,
  ...
  dplyr::left_join(
    model_data_wp %>% #add_wp_vars() %>%
      dplyr::select(lead_player, lead_player_id, match_id,utc_start_time,home_away,away_team_team_name,home_team_team_name,
