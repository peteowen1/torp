...
- [`calculate_epr()`](https://peteowen1.github.io/torp/reference/calculate_epr.md)
  [`calculate_torp_ratings()`](https://peteowen1.github.io/torp/reference/calculate_epr.md)
...
- [`default_epv_params()`](https://peteowen1.github.io/torp/reference/default_epv_params.md)
  [`default_credit_params()`](https://peteowen1.github.io/torp/reference/default_epv_params.md)
...
- [`skill_position_map()`](https://peteowen1.github.io/torp/reference/skill_position_map.md)
...
- [`show_predictions()`](https://peteowen1.github.io/torp/reference/show_predictions.md)
  : Show TORP Match Predictions
- [`print(`*`<torp_sim_results>`*`)`](https://peteowen1.github.io/torp/reference/print.torp_sim_results.md)
  : Print simulation results
- [`prepare_final_dataframe()`](https://peteowen1.github.io/torp/reference/prepare_final_dataframe.md)
  : Prepare final dataframe
- [`ladder`](https://peteowen1.github.io/torp/reference/ladder.md) : AFL
...
- [`select_afl_xgb_vars()`](https://peteowen1.github.io/torp/reference/select_afl_xgb_vars.md)
...
- [`AFL_TEAMS`](https://peteowen1.github.io/torp/reference/AFL_TEAMS.md)
...
- [`match_injuries()`](https://peteowen1.github.io/torp/reference/match_injuries.md)
...
Access AFL data directly from the API
