...
**Orientation at the source (issue \#92).** The AFL API records
coordinates in the **possessing chain’s attacking frame**
(`matchChains[i].teamId`), not the acting player’s team. The old
pipeline oriented off the actor, mis-flipping ~7% of shots (and ~12% of
possession-change rows). The fix captures `chain_team_id` +
`mp_home_team_id` in the scraper and orients **step A** off the chain
frame (`coord_team_id` vs `coord_home_team_id`). With orientation
correct at the source, the former neighbour-cascade sign-flip net (old
steps D/E/F) modifies **zero rows** (verified by ablation over two full
seasons) and has been **removed** — it was a symptom treatment for jumps
the orientation bug itself generated. The remaining pipeline:
...
Constants in `R/constants_data.R`: `COORD_JUMP_THRESHOLD` (100m) gates
the step-C flip check; `COORD_FLIP_TOLERANCE` (70m) is the max flipped
distance to classify as a sign error. Post-#92 the jump-detection is
near-inert — coordinate correctness is delivered by step A’s
orientation, not by the cascade.
...
**Key Files**: `R/simulate.R`, `R/ladder.R`, `R/finals_sim.R`,
`R/season_sim.R`, `R/injuries_scrape.R`, `R/injuries_match.R`,
`R/injuries_schedule.R`
...
| Ladder | `R/ladder.R` | [`calculate_ladder()`](https://peteowen1.github.io/torp/reference/calculate_ladder.md), [`calculate_final_ladder()`](https://peteowen1.github.io/torp/reference/calculate_final_ladder.md) |
| Finals Simulation | `R/finals_sim.R` | [`simulate_finals()`](https://peteowen1.github.io/torp/reference/simulate_finals.md), [`simulate_match()`](https://peteowen1.github.io/torp/reference/simulate_match.md), [`finals_home_advantage()`](https://peteowen1.github.io/torp/reference/finals_home_advantage.md) |
| Season Simulation | `R/season_sim.R` | [`simulate_afl_season()`](https://peteowen1.github.io/torp/reference/simulate_afl_season.md), [`prepare_sim_data()`](https://peteowen1.github.io/torp/reference/prepare_sim_data.md), [`summarise_simulations()`](https://peteowen1.github.io/torp/reference/summarise_simulations.md) |
| Injury Scraping | `R/injuries_scrape.R` | [`scrape_injuries()`](https://peteowen1.github.io/torp/reference/scrape_injuries.md), [`load_preseason_injuries()`](https://peteowen1.github.io/torp/reference/load_preseason_injuries.md) |
| Injury Matching | `R/injuries_match.R` | [`get_all_injuries()`](https://peteowen1.github.io/torp/reference/get_all_injuries.md), [`match_injuries()`](https://peteowen1.github.io/torp/reference/match_injuries.md), [`parse_return_round()`](https://peteowen1.github.io/torp/reference/parse_return_round.md) |
| Injury Schedule | `R/injuries_schedule.R` | [`build_injury_schedule()`](https://peteowen1.github.io/torp/reference/build_injury_schedule.md), [`save_injury_data()`](https://peteowen1.github.io/torp/reference/save_injury_data.md) |
| Injury Validation | `R/injuries_validation.R` | [`test_played_rate()`](https://peteowen1.github.io/torp/reference/test_played_rate.md), [`tbc_played_rate()`](https://peteowen1.github.io/torp/reference/tbc_played_rate.md), [`injury_return_accuracy()`](https://peteowen1.github.io/torp/reference/injury_return_accuracy.md), [`tbc_return_survival()`](https://peteowen1.github.io/torp/reference/tbc_return_survival.md) |
